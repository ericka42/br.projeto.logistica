...
public class FrmCadastrarCaminhao {
	...
	private void initialize() {
		...
		btnSalvar.setIcon(new ImageIcon(FrmCadastrarCaminhao.class.getResource("/br/projeto/logistica/icon/img-disquete.png")));
		...
		btnCancelar.setIcon(new ImageIcon(FrmCadastrarCaminhao.class.getResource("/br/projeto/logistica/icon/img-cancela.png")));
		btnCancelar.setBounds(10, 340, 120, 29);
		frame.getContentPane().add(btnCancelar);
		
		btnNovo = new JButton("  Novo");
		btnNovo.setIcon(new ImageIcon(FrmCadastrarCaminhao.class.getResource("/br/projeto/logistica/icon/img-novo.png")));
